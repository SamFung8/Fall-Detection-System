...
model = keras.models.load_model('f2_b16_54.h5') #(f1_b16_54 / f2_b16_54)
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if (processDataFrameCheckpoint + 30) == frame and processDataFrameCheckpoint != 0:
        ...
        if (processDataFrameCheckpoint + 250) == frame and processDataFrameCheckpoint != 0:
            ...
            _thread.start_new_thread( processDataAPI.send_email_message, (gifName, webcamID, ) )
