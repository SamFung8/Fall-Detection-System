...
<head>
	...
	<link href="../style/app_fallRecord.css" rel="stylesheet">
		...
		<div class="ht_banner">
			<div class="container">
				<div class="container-main">
					...
					<button class="btn_all btn_register" onclick="goToDetail()">Check Fall Detail</button>
					<script>
						function goToDetail() {
							window.location.href = 'fallRecord_app.php';
						}
					</script>
          ...
          echo"
            ...
            <div class='card-vertical'>
              <div class='img-square-wrapper'>
                <a href=''><img class='img-house' src='../img/$picture.jpg' alt='' width='95%' ></a>
              </div>
              <div class='card-body'>
